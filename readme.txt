...
mixColumns
In the mixColumns we 

galoisMultiplication
We were slightly confused on how to matrix multiply with the galois fields so we looked up videos on how to do it
